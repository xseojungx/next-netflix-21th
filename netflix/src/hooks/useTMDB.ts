...
export const usePopularMovies = (params: TMDBQueryParams = {}) => {
  return useQuery<MovieResponse>({
    queryKey: ['popularMovies', params],
    queryFn: () => fetchTMDB('/movie/popular', params as Record<string, string | number>),
  });
};
...
export const useUpcomingMovies = (params: TMDBQueryParams = {}) => {
  return useQuery<MovieResponse>({
    ...
    queryFn: () => fetchTMDB('/movie/upcoming', params as Record<string, string | number>),
  });
};
...
export const useMovieDetails = (movieId: number) => {
  return useQuery<MovieDetails>({
    ...
    queryFn: () => fetchTMDB(`/movie/${movieId}`, { append_to_response: 'videos' }),
    enabled: !!movieId,
  });
};

export const useSearchMovies = (query: string, params: TMDBQueryParams = {}) => {
  return useQuery<MovieResponse>({
